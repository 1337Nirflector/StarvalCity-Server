...
public class FilePathManager {
    ...
    public static String GER_frequent_messages_insufficient_permissions_PATH = "Vielmalige_Nachrichten.Nicht_genug_Rechte";
    ...
    // Frequent messages
    public static String ENG_frequent_messages_insufficient_permissions_PATH = "Frequent_Messages.Insufficient_Permissions";
